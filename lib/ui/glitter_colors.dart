...
class GlitterColors {
  ...
  // glitter backgrounds: light mode uses the same deep purple as `darkBg`
  // (so titles read as a near-black silhouette against the pink), dark
  // mode keeps the pale lilac that pops on the deep-purple bg.
  static const lightContent = Color(0xFF2A1A3E);
